...
/**
 * HiPsndocGrpdef2 generated by hbm2java
 */
@Entity
@Table(name = "HI_PSNDOC_GRPDEF2", schema = "NC58")
public class HiPsndocGrpdef2 implements java.io.Serializable {
	...
	public HiPsndocGrpdef2() {
	}

	public HiPsndocGrpdef2(String pkPsndocSub, String pkPsndoc) {
		this.pkPsndocSub = pkPsndocSub;
		this.pkPsndoc = pkPsndoc;
	}

	public HiPsndocGrpdef2(String pkPsndocSub, BigDecimal approveflag, String begindate, Long dr, String enddate,
