...
<table cellspacing="0" cellpadding="1">
	...
	<tr><td class="td3" colspan="4" align="center"><h2>安全管理高压线考核通知单</h2></td></tr>
	...
	<tr align="center"><td><strong>责任部门：</strong></td><td>${adquality.dept}</td><td><strong>外协单位：</strong></td><td>
	<#if adquality.wbdept ??> 	
	${adquality.wbdept}</#if></td></tr>
	<tr><td colspan="4"><strong>违章情节文字描述和责任认定：</strong><br />${adquality.miaoshu}
					<div align="center" >
					    <#if adquality.image1 ??>  
