Ext.define("core.employee.report.bills.quality.reward.view.RewardListGrid", {
			extend:"Ext.grid.Panel",
			alias : 'widget.RewardListGrid',
			autoScroll :true,
			minheight:250,
			store:"core.employee.report.bills.quality.reward.store.RewardListStore",
