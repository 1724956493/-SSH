Ext.define("core.employee.quality.bills.rewardApprove.view.RewardApproveGrid", {
			extend:"Ext.grid.Panel",
			alias : 'widget.RewardApproveGrid',
			autoScroll :true,
			minheight:250,
			store:"core.employee.quality.bills.rewardApprove.store.RewardApproveStore",
			...
			columns: [            
	            ...
	            //  			metadata.style = 'background-color:#CCFFFF;'; 
	              ...
	              {text: '奖励总金额', dataIndex: 'totalreward', align: 'center'}
	            ],
