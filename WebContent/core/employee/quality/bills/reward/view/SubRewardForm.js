Ext.define("core.employee.quality.bills.reward.view.SubRewardForm", {
			extend: 'Ext.form.Panel',
			alias: 'widget.SubRewardForm',
			defaults : {
				margin :'10 5 10 5'			
			},
	...
	items:[
		...
		{xtype: 'combo',fieldLabel: '职责级别:',allowBlank : false, forceSelection:true,store:['员工','班组长','外包队负责','QA','主管','主管领导','区域负责人','部门长'],name:'joblevel'},
		{xtype: 'numberfield',fieldLabel: '奖励金额:',allowBlank : false, minValue: 0,name:'reward'},
