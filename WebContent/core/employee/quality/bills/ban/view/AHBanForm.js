Ext.define("core.employee.quality.bills.ban.view.AHBanForm", {
			extend: 'Ext.form.Panel',
			alias: 'widget.AHBanForm',
			autoScroll:true,
			layout :'column',
	    //    layout:'vbox',
	
		tbar:[{xtype: 'button', text: '高压线保存',ref:'save',formBind : true},
		...
		items:[				
					...
					//	{xtype: 'htmleditor',fieldLabel:'事故分析',name:'fenxi',margin: '5 40 0 20',columnWidth: 1,enableFont :false},
						{xtype: 'combo',fieldLabel: '处罚依据:',columnWidth: 1,margin: '5 40 0 20',name:'yiju',store:"core.employee.quality.bills.ban.store.AHForbidtypeStore",queryMode: 'local',valueField: 'typename',displayField: 'typename', editable : false,allowBlank :false},
